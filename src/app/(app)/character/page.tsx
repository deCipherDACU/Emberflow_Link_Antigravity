...
export default function CharacterPage() {
    ...
    const { xpToNext, currentLevelXP } = getProgressToNextLevel(user.xp, user.level);
    ...
    return (
        <>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5 mb-8">
                <StatCard title="Level" value={displayLevel} icon={<Trophy />} description={`${currentLevelXP.toLocaleString()} / ${xpToNext.toLocaleString()} XP`} />
