...
import { getProgressToNextLevel } from "@/lib/formulas";
...
export default function DashboardPage() {
  ...
  const { percentComplete: levelProgress, xpToNext, currentLevelXP } = getProgressToNextLevel(user.xp, user.level);
        ...
        <div className="grid gap-4 md:grid-cols-3 mb-6">
            <LiquidGlassCard className="flex items-center gap-4 p-4">
                ...
                <div>
                    ...
                    <p className="text-xs text-muted-foreground">{currentLevelXP.toLocaleString()} / {xpToNext.toLocaleString()} XP</p>
                </div>
            </LiquidGlassCard>
             <LiquidGlassCard className="flex items-center gap-4 p-4">
